  ...
  experience: [
    {
      ...
      company: 'Alignment',
      description: 'Defining the product vision, user experience, and visual direction.',
    },
    {
      year: 'Phase 02',
      role: 'Robust Engineering',
      company: 'Execution',
      description: 'Building scalable, performant systems with modern technology.',
    },
    {
      year: 'Phase 03',
      role: 'Growth & Scaling',
